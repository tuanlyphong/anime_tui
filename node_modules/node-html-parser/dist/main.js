...
define("nodes/node", ["require", "exports", "entities"], function (require, exports, entities_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("nodes/text", ["require", "exports", "entities", "nodes/node", "nodes/type"], function (require, exports, entities_2, node_1, type_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var TextNode = /** @class */ (function (_super) {
        ...
        Object.defineProperty(TextNode.prototype, "text", {
             ...
             */
            get: function () {
                return (0, entities_2.decodeHTML)(this.rawText);
            },
            enumerable: false,
            configurable: true
        });
...
define("nodes/html", ["require", "exports", "css-select", "entities", "back", "matcher", "void-tag", "nodes/comment", "nodes/node", "nodes/text", "nodes/type"], function (require, exports, css_select_1, entities_3, back_1, matcher_1, void_tag_1, comment_1, node_2, text_1, type_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function decode(val) {
        return (0, entities_3.decodeHTML)(val);
    }
    ...
    function base_parse(data, options) {
        ...
        var hasCDATA = data.includes('<![CDATA[');
        var markupPattern = hasCDATA ? kMarkupPatternWithCDATA : kMarkupPattern;
        ...
        while ((match = markupPattern.exec(data))) {
            ...
            var tagStartPos = markupPattern.lastIndex - matchLength;
            var tagEndPos = markupPattern.lastIndex;
            ...
            if (!leadingSlash) {
                ...
                var tagEndPos_1 = markupPattern.lastIndex;
